...
| Must-gather image  | Not in this distribution (Red Hat support uses a separate image) | Attach gate `--json` to the case; do not expect a must-gather image from this snapshot |
