...
Continuous export of per-VM evidence completeness (Issue K, Phase 1 of R-27's
broader fleet gate-verdict export mandate -- see
`docs/info/peer-reviews/v0.19.0/issues/gitlab-issue-drafts-open-after-remediation.md`,
`docs/design/r-27-fleet-gate-verdict-exporter.md`, and
`scripts/cnv-bsod-fleet-exporter.sh`'s module header).
...
phase (deferred until there is live data to calibrate thresholds against; see
`docs/design/r-27-fleet-gate-verdict-exporter.md`'s phasing table and
resolution notes).
...
See `docs/design/r-27-fleet-gate-verdict-exporter.md` §6.9/§11 for the full
reasoning.
